local config = {
    ...
    ["dwarf"] = {count = 50, storage = 1002, start = 1, plural = "dwarves"},
    ["dwarf soldier"] = {count = 50, storage = 1002, start = 1, plural = "dwarves"},

    ["ghoul"] = {count = 50, storage = 1003, start = 1, plural = "ghouls"},
    ["goblin"] = {count = 50, storage = 1004, start = 1, plural = "goblins"},
    ["larva"] = {count = 50, storage = 1005, start = 1, plural = "larva"},
    ...
    ["orc"] = {count = 100, storage = 1008, start = 1, plural = "orcs all kind"},
    ["orc shaman"] = {count = 100, storage = 1008, start = 1, plural = "orcs all kind"},
    ["orc rider"] = {count = 100, storage = 1008, start = 1, plural = "orcs all kind"},
    ["orc warlord"] = {count = 100, storage = 1008, start = 1, plural = "orcs all kind"},
    ["orc leader"] = {count = 100, storage = 1008, start = 1, plural = "orcs all kind"},
    ["orc berserker"] = {count = 100, storage = 1008, start = 1, plural = "orcs all kind"},
    ["orc warrior"] = {count = 100, storage = 1008, start = 1, plural = "orcs all kind"},

    --["panda"] = {count = 150, storage = 1009, start = 1, plural = "pandas"},

    ["scarab"] = {count = 50, storage = 1010, start = 1, plural = "scarabs"},
    ...
    ["black knight"] = {count = 15, storage = 1015, start = 1, plural = "black knight"},

    ["cyclops"] = {count = 60, storage = 1016, start = 1, plural = "cyclopses"},

    ["demon skeleton"] = {count = 100, storage = 1017, start = 1, plural = "demon skeleton"},

    ["dragon"] = {count = 50, storage = 1018, start = 1, plural = "dragons"},

    ["dwarf guard"] = {count = 200, storage = 1019, start = 1, plural = "dwarf guards"},

    ["fire elemental"] = {count = 25, storage = 1020, start = 1, plural = "fire elementals"},

    ["giant spider"] = {count = 60, storage = 1021, start = 1, plural = "giant spiders"},
    ...
    ["witch"] = {count = 25, storage = 1040, start = 1, plural = "witch"},
    ...
    ["beholder"] = {count = 20, storage = 1051, start = 1, plural = "beholders"},
    ["crypt shambler"] = {count = 25, storage = 1052, start = 1, plural = "crypt shamblers"},
    ["mummy"] = {count = 50, storage = 1053, start = 1, plural = "mummies"},
    ["rat"] = {count = 50, storage = 1054, start = 1, plural = "rats"},
	["fire devil"] = {count = 25, storage = 1055, start = 1, plural = "fire devils"},
}
...
function onKill(player, target)
    ...
    if storageValue >= monster.start then
        if storageValue >= monster.count then
            player:sendTextMessage(MESSAGE_STATUS_CONSOLE_BLUE, "You have already killed " .. monster.count .. " " .. monster.plural .. ". Report back to the King in Thais.")
        else
